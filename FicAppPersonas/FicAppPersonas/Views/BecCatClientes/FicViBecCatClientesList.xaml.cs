...
namespace FicAppPersonas.Views.BecCatClientes
{
    ...
    public partial class FicViBecCatClientesList : ContentPage
    {

        private static readonly IFicAsyncLock ficMutex = new IFicAsyncLock();
        private readonly FicDBContext FicLoDBContext;
        private readonly rh_cat_personas persona;
        public FicViBecCatClientesList()
        {
            InitializeComponent();
            FicLoDBContext = new FicDBContext(DependencyService.Get<IFicConfigSQLite>().FicGetDataBasePath());
            BindingContext = App.FicVmLocator.FicVmBecCatClientesList;
        }//CONSTRUCTOR

        public FicViBecCatClientesList(rh_cat_personas per)
        {
            InitializeComponent();
        ...
        {
            var context = BindingContext as FicVmBecCatClientesList;
        ...
        public async Task FicMetRemoveEdificio(bec_cat_clientes item)
        {
        ...
        {
            var FicViewModel = BindingContext as FicVmBecCatClientesList;
